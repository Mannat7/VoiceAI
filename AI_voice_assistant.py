...
if __name__=='__main__':
    ...
    while True:
        ...
        if 'wikipedia' in statement:
            ...
            speak('I am your personal voice assistant version 1 point O. I am programmed to do minor tasks like'
            ...
            speak("I was built by Mannat")
            print("I was built by Mannat")
